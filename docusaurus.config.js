const config = {
  ...
  tagline:
    "Product, architecture, security, integrations, and delivery blueprint",
    ...
    [
      "classic",
      {
        docs: {
          ...
          routeBasePath: "/",
          editUrl:
            "https://github.com/autodidactcrew/restaurant-os-docs/edit/main/",
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/autodidactcrew/restaurant-os-docs",
          label: "GitHub",
          position: "right",
        },
      ],
          ...
          items: [
            {
              ...
              to: "/product-requirements/overview",
            },
            { label: "Architecture", to: "/solution-architecture/overview" },
          ],
        },
        {
          title: "Engineering",
          items: [
            { label: "Security", to: "/security/overview" },
            {
              ...
              to: "/device-integrations/overview",
            },
          ],
        },
      ],
